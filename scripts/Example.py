...
# see paths from here: files['ReXgEAFaPXY'].__dir__()
...
object_list = [{"id":"MXAAfbs4NC0","objectType":"FILE"}]
add_to_tag = file_api.add_objects_to_tag('BPlSBjfyRp8',object_list)
...
topic = topics[0]
tc_files = topic.tc_files # ['tc:V2lf33VC6-0', 'tc:LmovIhnBKiU'] - they are returned with frn notation, and are model_id, not version_id
